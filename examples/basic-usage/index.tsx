...
export default function App() {
  ...
  return (
    <div style={styles.app}>
      ...
      <p>
        아래 버튼을 눌러 드로어나 모달을 열고, 브라우저의 뒤로가기 버튼을
        눌러보세요. 가장 마지막에 열린 오버레이가 먼저 닫힙니다.
      </p>

      <div>
        <button style={styles.button} onClick={() => setIsDrawer1Open(true)}>
          드로어 1 열기
        </button>
        <button style={styles.button} onClick={() => setIsDrawer2Open(true)}>
          드로어 2 열기
        </button>
